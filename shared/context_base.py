...
class ContextBase( BasicRateLimited ):
    ...
    def get_param( self, param_name_IN, default_IN = None ):
        ...
        my_params = self.get_param_container()
        value_OUT = my_params.get_param( param_name_IN, default_IN )
    ...
    def get_request( self ):
        ...
        # retrieve request
        value_OUT = self.request

        return value_OUT

    #-- END method get_request() --#
    ...
    def store_parameters( self, params_IN ):
        ...
        """
            Method: store_parameters()

            Purpose: accepts a dictionary of parameters, stores it in nested
                ParameterContainer instance.
