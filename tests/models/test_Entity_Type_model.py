...
class Entity_TypeModelTest( django.test.TestCase ):
    ...
    # CLASS NAME
    CLASS_NAME = "Entity_TypeModelTest"
    ...
    def test_get_type_for_slug( self ):
        ...
        test_slug = TestHelper.ENTITY_TYPE_SLUG_PERSON
        
        # look it up.
        type_instance = Entity_Type.get_type_for_slug( test_slug )
        ...
        test_slug = TestHelper.ENTITY_TYPE_SLUG_ARTICLE
...
#-- END test class Entity_TypeModelTest --#
